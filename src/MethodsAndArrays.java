...
public class MethodsAndArrays {//this is your driver class
	...
	public static void main(String[] args) {
		...
		try{System.out.println("Enter the number of dies you want to roll and how many sides of the dice you are using?");
		System.out.print("Number of dies: ");
		dice = input.nextInt();
		System.out.print("Number of sides: ");
		sides = input.nextInt();
		
		System.out.println(game.rollDice(dice,sides)); //display the method from Game class via the reference - game
		}
		
		catch(Exception e){System.out.println("You have entered invalid data!");}
		
	}
	/* - replaced by the rollDice method in the game class
	 * 
